...
@section('page-title', 'Add Expense Transaction')
...
<div class="form-container">
    <div class="form-header">
        ...
        <p>Record a new expense entry with auto-generated invoice number</p>
    </div>
    ...
    <form action="{{ route('admin.financial.storeExpense') }}" method="POST">
        @csrf
        ...
        <div class="form-group">
            ...
            <select id="category" name="category" required>
                ...
                <option value="salary" {{ old('category') == 'salary' ? 'selected' : '' }}>Shopping</option>
                <option value="equipment" {{ old('category') == 'equipment' ? 'selected' : '' }}>🔧 </option>
                <option value="software" {{ old('category') == 'software' ? 'selected' : '' }}>💻 Data (Internet)</option>
        ...
        <div class="form-group">
            ...
            <input type="text" id="description" name="description" placeholder="e.g., Office supplies purchase" value="{{ old('description') }}" required>
            <p class="help-text">Brief description of the expense</p>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <select id="currency" name="currency" required>
                    <option value="USD" {{ old('currency', 'USD') == 'USD' ? 'selected' : '' }}>FJD</option>
                    <option value="EUR" {{ old('currency') == 'EUR' ? 'selected' : '' }}>EUR</option>
                    <option value="GBP" {{ old('currency') == 'GBP' ? 'selected' : '' }}>GBP</option>
                    <option value="FJD" {{ old('currency') == 'FJD' ? 'selected' : '' }}>USD</option>
                </select>
            </div>
        </div>
