...
<div class="income-container">
    <a href="/admin/financial" class="back-button">â† Back to Dashboard</a>

    <div class="page-header">
        <h1>ðŸ’° Income Management</h1>
    ...
    <div class="form-section" style="background: linear-gradient(135deg, rgba(179, 217, 255, 0.2) 0%, rgba(179, 255, 179, 0.2) 100%);">
        <h2 class="section-title">ðŸ“Š Income Summary</h2>
        <div class="summary-cards" style="grid-template-columns: repeat(auto-fit, minmax(160px, 1fr));">
            <div class="summary-card" style="background: linear-gradient(135deg, #B3D9FF 0%, #a5d4ff 100%);">
                <div class="summary-card-label">ðŸ’µ Total Income</div>
            ...
            <div class="summary-card" style="background: linear-gradient(135deg, #B3FFB3 0%, #a5ffa5 100%);">
                <div class="summary-card-label">ðŸ“… This Month</div>
                ...
                <div style="font-size: 11px; color: {{ ($monthlyChange ?? 0) >= 0 ? '#16A34A' : '#DC2626' }}; margin-top: 4px; font-weight: 600;">
                    {{ ($monthlyChange ?? 0) >= 0 ? 'â†‘' : 'â†“' }} {{ abs($monthlyChange ?? 0) }}% vs last month
                </div>
            </div>
            <div class="summary-card" style="background: linear-gradient(135deg, #FFD9B3 0%, #ffcca5 100%);">
                <div class="summary-card-label">ðŸ“† Last Month</div>
            ...
            <div class="summary-card" style="background: linear-gradient(135deg, #D9B3FF 0%, #cca5ff 100%);">
                <div class="summary-card-label">ðŸ“ˆ This Year</div>
            ...
            <div class="summary-card" style="background: linear-gradient(135deg, #FFB3D9 0%, #ffa5cc 100%);">
                <div class="summary-card-label">ðŸ“Š Avg/Month</div>
            ...
            <div class="summary-card" style="background: linear-gradient(135deg, #B3FFD9 0%, #a5ffcc 100%);">
                <div class="summary-card-label">ðŸŽ¯ Top Source</div>
    ...
    <div class="form-section" style="background: linear-gradient(135deg, rgba(179, 217, 255, 0.1) 0%, rgba(179, 255, 179, 0.1) 100%); border-left: 5px solid #B3D9FF;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px; padding-bottom: 10px; border-bottom: 3px solid #B3D9FF;">
            <h2 class="section-title" style="color: #0F172A; font-size: 20px; border-bottom: none; margin: 0;">ðŸ’¼ Income Sources</h2>
        ...
        <div id="incomeSourceFormContainer" style="display: none; margin-bottom: 20px;">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select id="category" required>
                            ...
                            <option value="client_payment">ðŸ‘¥ Client Payment</option>
                            <option value="equipment">ðŸ–¥ï¸ Equipment/Sales</option>
                            <option value="software">ðŸ’» Software/Services</option>
                            <option value="travel">âœˆï¸ Travel/Reimbursement</option>
                            <option value="utilities">âš¡ Utilities/Refund</option>
                            <option value="marketing">ðŸ“¢ Marketing/Bonus</option>
                            <option value="savings">ðŸ¦ Savings Transfer</option>
                            <option value="investment_return">ðŸ“ˆ Investment Return</option>
                            ...
                            <option value="other">ðŸ“Œ Other Income</option>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select id="type" required>
                            ...
                            <option value="variable">ðŸ“Š Variable</option>
                        </select>
                    </div>
                </div>
        ...
        <div style="overflow-x: auto;">
            <table id="incomeSourcesTable" style="width: 100%; border-collapse: collapse; display: none; font-size: 13px;">
                <thead>
                    <tr style="background: linear-gradient(135deg, #B3D9FF 0%, #a5d4ff 100%); border-bottom: 2px solid #0F172A;">
                        <th style="padding: 10px 12px; text-align: left; font-weight: 700; color: #0F172A; border-right: 1px solid rgba(0,0,0,0.1);">Source Name</th>
                        <th style="padding: 10px 12px; text-align: left; font-weight: 700; color: #0F172A; border-right: 1px solid rgba(0,0,0,0.1);">Category</th>
                        <th style="padding: 10px 12px; text-align: left; font-weight: 700; color: #0F172A; border-right: 1px solid rgba(0,0,0,0.1);">Type</th>
                        <th style="padding: 10px 12px; text-align: center; font-weight: 700; color: #0F172A;">Actions</th>
                    </tr>
                </thead>
                <tbody id="incomeSourcesTableBody"></tbody>
            </table>
            <div id="noSourcesMessage" style="text-align: center; padding: 20px; color: #999; font-size: 13px; background: white; border-radius: 8px; border: 1px solid #e8e8e8;">
                ðŸ“­ No income sources yet. Add one using the form above.
            </div>
        </div>
    </div>
    ...
    <div class="form-section" style="background: linear-gradient(135deg, rgba(179, 255, 179, 0.1) 0%, rgba(179, 217, 255, 0.1) 100%); border-left: 5px solid #B3FFB3;">
        <h2 class="section-title" style="color: #0F172A; font-size: 20px; border-bottom: 3px solid #B3FFB3;">ðŸ“… Monthly Income Budget</h2>
        ...
        <form id="budgetForm">
            <div class="form-row" style="gap: 10px;">
                ...
                <div style="display: flex; align-items: flex-end;">
                    <button type="button" class="btn btn-primary" onclick="saveBudget()" style="padding: 8px 14px; font-size: 12px; margin-bottom: 0;">ðŸ’¾ Save Budget</button>
                </div>
            </div>
        </form>
        ...
        <div id="budgetDisplayCard" style="display: none; margin-top: 20px;">
            <div class="card-row" style="grid-template-columns: 1fr auto; gap: 20px;">
                <div class="card-content">
                    <div class="card-title">ðŸ’° Current Budget</div>
                    <div class="card-meta">
                ...
                <div class="card-actions">
                    <button type="button" class="btn btn-small btn-edit" onclick="editBudget()">âœï¸ Edit</button>
                    <button type="button" class="btn btn-small btn-delete" onclick="clearBudget()">ðŸ—‘ï¸ Clear</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="form-section" style="background: linear-gradient(135deg, rgba(179, 255, 179, 0.1) 0%, rgba(179, 217, 255, 0.1) 100%); border-left: 5px solid #B3FFB3;">
        <h2 class="section-title" style="color: #0F172A; font-size: 20px; border-bottom: 3px solid #B3FFB3;">ðŸ“‹ Income Transactions</h2>
        ...
        <form id="incomeTrackingForm">
            ...
            <button type="button" class="btn btn-primary" onclick="saveActualIncome()" style="background: linear-gradient(135deg, #B3D9FF 0%, #a5d4ff 100%); font-weight: 700; box-shadow: 0 4px 12px rgba(179, 217, 255, 0.3);">ðŸ’¾ Save Income Transaction</button>
        </form>
        ...
        <div style="margin-top: 30px;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px; padding-bottom: 10px; border-bottom: 3px solid #B3FFB3;">
                <h3 style="font-size: 16px; font-weight: 700; color: #0F172A; margin: 0;">ðŸ“Š Transaction History</h3>
            ...
            <div id="transactionHistoryContainer" style="display: none;">
                ...
                <div style="overflow-x: auto; background: white; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                    <table id="incomeTransactionsTable" style="width: 100%; border-collapse: collapse; display: none;">
                        <thead>
                            <tr style="background: linear-gradient(135deg, #B3D9FF 0%, #B3FFB3 100%); border-bottom: 3px solid #0F172A;">
                                <th style="padding: 15px; text-align: left; font-weight: 700; color: #0F172A; font-size: 13px; border-right: 1px solid rgba(0,0,0,0.1);">Date</th>
                                <th style="padding: 15px; text-align: left; font-weight: 700; color: #0F172A; font-size: 13px; border-right: 1px solid rgba(0,0,0,0.1);">Description</th>
                                <th style="padding: 15px; text-align: left; font-weight: 700; color: #0F172A; font-size: 13px; border-right: 1px solid rgba(0,0,0,0.1);">Category</th>
                                <th style="padding: 15px; text-align: right; font-weight: 700; color: #0F172A; font-size: 13px; border-right: 1px solid rgba(0,0,0,0.1);">Amount</th>
                                <th style="padding: 15px; text-align: left; font-weight: 700; color: #0F172A; font-size: 13px; border-right: 1px solid rgba(0,0,0,0.1);">Account</th>
                                <th style="padding: 15px; text-align: center; font-weight: 700; color: #0F172A; font-size: 13px; border-right: 1px solid rgba(0,0,0,0.1);">Status</th>
                                <th style="padding: 15px; text-align: center; font-weight: 700; color: #0F172A; font-size: 13px;">Actions</th>
                            </tr>
                        </thead>
                ...
                <!-- Pagination Controls -->
                <div id="paginationControls" style="display: none; margin-top: 20px; text-align: center; padding: 15px; background: white; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                    <button type="button" class="btn btn-primary" onclick="previousPage()" style="margin-right: 10px; background: linear-gradient(135deg, #B3FFB3 0%, #a5ffa5 100%); font-weight: 600;">â† Previous</button>
                    <span id="pageInfo" style="margin: 0 15px; font-weight: 700; color: #0F172A; font-size: 14px;"></span>
                    <button type="button" class="btn btn-primary" onclick="nextPage()" style="margin-left: 10px; background: linear-gradient(135deg, #B3FFB3 0%, #a5ffa5 100%); font-weight: 600;">Next â†’</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="form-section" style="background: linear-gradient(135deg, rgba(179, 217, 255, 0.1) 0%, rgba(179, 255, 179, 0.1) 100%); border-left: 5px solid #B3D9FF;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px; padding-bottom: 10px; border-bottom: 3px solid #B3D9FF;">
            <h2 class="section-title" style="color: #0F172A; font-size: 20px; border-bottom: none; margin: 0;">ðŸ¦ Account Management</h2>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select id="accountType" required>
                            ...
                            <option value="bank_savings">ðŸ¦ Bank Savings</option>
                            <option value="bank_expense">ðŸ¦ Bank Expense</option>
        ...
        <div style="margin-top: 20px;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px; padding-bottom: 10px; border-bottom: 3px solid #B3D9FF;">
                <h3 style="font-size: 16px; font-weight: 700; color: #0F172A; margin: 0;">ðŸ“‹ Added Accounts</h3>
            ...
            <div id="accountsTableContainer" style="display: none;">
                <!-- Table Format -->
                <div style="overflow-x: auto; background: white; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                    <table id="accountsListTable" style="width: 100%; border-collapse: collapse; display: none;">
                        <thead>
                            <tr style="background: linear-gradient(135deg, #B3D9FF 0%, #a5d4ff 100%); border-bottom: 3px solid #0F172A;">
                                <th style="padding: 15px; text-align: left; font-weight: 700; color: #0F172A; font-size: 13px; border-right: 1px solid rgba(0,0,0,0.1);">Account Name</th>
                                <th style="padding: 15px; text-align: left; font-weight: 700; color: #0F172A; font-size: 13px; border-right: 1px solid rgba(0,0,0,0.1);">Type</th>
                                <th style="padding: 15px; text-align: right; font-weight: 700; color: #0F172A; font-size: 13px; border-right: 1px solid rgba(0,0,0,0.1);">Balance</th>
                                <th style="padding: 15px; text-align: left; font-weight: 700; color: #0F172A; font-size: 13px; border-right: 1px solid rgba(0,0,0,0.1);">Created</th>
                                <th style="padding: 15px; text-align: center; font-weight: 700; color: #0F172A; font-size: 13px;">Actions</th>
                            </tr>
                        </thead>
    ...
    <div class="form-section">
        <h2 class="section-title">ðŸ“ˆ Income Analytics</h2>
        
        <div class="charts-grid">
            <div class="chart-container">
                <div class="chart-title">ðŸ’° Total Budgeted vs Actual</div>
                <div class="chart-wrapper" style="height: 180px;">
                    <canvas id="incomeSummaryChart" style="max-width: 100%; max-height: 180px;"></canvas>
                </div>
            </div>
            <div class="chart-container">
                <div class="chart-title">ðŸŽ¯ Income Sources Breakdown</div>
                <div class="chart-wrapper" style="height: 180px;">
                    <canvas id="incomeSourcesBreakdownChart" style="max-width: 100%; max-height: 180px;"></canvas>
                </div>
            </div>
            <div class="chart-container">
                <div class="chart-title">ðŸ“Š Income Distribution by Category</div>
                <div class="chart-wrapper" style="height: 180px;">
...
<script>
    ...
    function updateIncomeSourcesTable() {
        ...
        incomeSources.forEach((source, index) => {
            ...
            row.innerHTML = `
                <td style="padding: 10px 12px; text-align: left; color: #333; border-right: 1px solid rgba(0,0,0,0.1); font-weight: 600;">ðŸ’¼ ${source.sourceName}</td>
                <td style="padding: 10px 12px; text-align: left; color: #333; border-right: 1px solid rgba(0,0,0,0.1);">
                    <span style="display: inline-block; padding: 4px 10px; border-radius: 12px; background: linear-gradient(135deg, #B3D9FF 0%, #a5d4ff 100%); color: #0F172A; font-weight: 600; font-size: 11px;">${source.category}</span>
                </td>
                <td style="padding: 10px 12px; text-align: left; color: #333; border-right: 1px solid rgba(0,0,0,0.1);">
                    <span style="display: inline-block; padding: 4px 10px; border-radius: 12px; background: linear-gradient(135deg, #B3FFB3 0%, #a5ffa5 100%); color: #0F172A; font-weight: 600; font-size: 11px;">${source.type}</span>
                </td>
                <td style="padding: 10px 12px; text-align: center; color: #333;">
                    <button type="button" class="btn btn-small btn-view" onclick="viewIncomeSource(${source.id})" style="padding: 6px 10px; font-size: 11px; margin-right: 4px;">ðŸ‘ï¸</button>
                    <button type="button" class="btn btn-small btn-edit" onclick="editIncomeSource(${source.id})" style="padding: 6px 10px; font-size: 11px; margin-right: 4px;">âœï¸</button>
                    <button type="button" class="btn btn-small btn-delete" onclick="openDeleteModal(${source.id}, 'source')" style="padding: 6px 10px; font-size: 11px;">ðŸ—‘ï¸</button>
                </td>
            `;
    ...
    function saveActualIncome() {
        ...
        if (!incomeDate || !incomeSourceId || !amount || amount <= 0 || !accountId) {
            showAlert('Please fill in all required fields', 'error');
            return;
        }
        
        // Find the account name from allAccounts
        const selectedAccount = allAccounts.find(a => a.id == accountId);
        const accountName = selectedAccount ? selectedAccount.name : 'Unknown';
    ...
    function displayIncomeTransactions() {
        const table = document.getElementById('incomeTransactionsTable');
        ...
        pageTransactions.forEach((transaction, index) => {
            ...
            const accountLabel = {
                'cash': 'Cash On Hand',
                'anz_expense': 'Bank Expense',
                'anz_savings': 'Bank Savings',
                'other': 'Other'
            };
            
            const accountDisplay = transaction.account ? `${accountEmoji[transaction.account] || 'ðŸ’³'} ${accountLabel[transaction.account] || transaction.account}` : 'N/A';

            row.innerHTML = `
                <td style="padding: 15px; text-align: left; font-size: 13px; color: #333; border-right: 1px solid #e8e8e8; font-weight: 500;">${date}</td>
                <td style="padding: 15px; text-align: left; font-size: 13px; color: #333; border-right: 1px solid #e8e8e8; font-weight: 600;">ðŸ’° ${description}</td>
                <td style="padding: 15px; text-align: left; font-size: 13px; color: #333; border-right: 1px solid #e8e8e8;">
                    <span style="display: inline-block; padding: 4px 10px; border-radius: 12px; background: linear-gradient(135deg, #B3D9FF 0%, #a5d4ff 100%); color: #0F172A; font-weight: 600; font-size: 11px;">${category}</span>
                </td>
                <td style="padding: 15px; text-align: right; font-size: 13px; color: #16A34A; border-right: 1px solid #e8e8e8; font-weight: 700;">${amount}</td>
                <td style="padding: 15px; text-align: left; font-size: 13px; color: #333; border-right: 1px solid #e8e8e8;">
                    <span style="display: inline-block; padding: 4px 10px; border-radius: 12px; background: linear-gradient(135deg, #FFD9B3 0%, #ffcca5 100%); color: #0F172A; font-weight: 600; font-size: 11px;">${accountDisplay}</span>
                </td>
                <td style="padding: 15px; text-align: center; font-size: 13px; border-right: 1px solid #e8e8e8;">
                    <span style="display: inline-block; padding: 4px 10px; border-radius: 12px; background: linear-gradient(135deg, #B3FFB3 0%, #a5ffa5 100%); color: #0F172A; font-weight: 600; font-size: 11px; text-transform: capitalize;">${status}</span>
                </td>
                <td style="padding: 15px; text-align: center; font-size: 13px;">
                    <button type="button" class="btn btn-small btn-view" onclick="viewTransaction(${transaction.id})" style="padding: 6px 10px; font-size: 11px; margin-right: 4px;">ðŸ‘ï¸</button>
                    <button type="button" class="btn btn-small btn-edit" onclick="editTransaction(${transaction.id})" style="padding: 6px 10px; font-size: 11px; margin-right: 4px;">âœï¸</button>
                    <button type="button" class="btn btn-small btn-delete" onclick="openDeleteModal(${transaction.id}, 'transaction')" style="padding: 6px 10px; font-size: 11px;">ðŸ—‘ï¸</button>
                </td>
            `;
            tbody.appendChild(row);
        });
    ...
    function editTransaction(id) {
        const transaction = allIncomeTransactions.find(t => t.id === id);
        if (transaction) {
            const date = new Date(transaction.transaction_date).toLocaleDateString('en-CA');
            document.getElementById('incomeDate').value = date;
            document.getElementById('actualMonthlyIncome').value = parseFloat(transaction.amount).toFixed(2);
            document.getElementById('incomeDescription').value = transaction.description || '';
            
            // Store the transaction ID for update
            document.getElementById('incomeTrackingForm').dataset.editingId = id;
            
            // Change button text
            const saveBtn = document.querySelector('button[onclick="saveActualIncome()"]');
            saveBtn.textContent = 'âœï¸ Update Income Transaction';
            saveBtn.style.background = 'linear-gradient(135deg, #B3FFB3 0%, #a5ffa5 100%)';
            
            document.getElementById('incomeTrackingForm').scrollIntoView({ behavior: 'smooth' });
            showAlert('Edit the transaction details and click "Update Income Transaction" to save changes', 'success');
        }
    }
    ...
    function updateIncomeSummaryChart() {
        ...
        const values = monthlyIncomeData.values || actualIncome || [];
        const firstHalf = values.slice(0, 6).reduce((a, b) => a + b, 0);
        const secondHalf = values.slice(6).reduce((a, b) => a + b, 0);
        
        console.log('Income Summary Chart Data:', { firstHalf, secondHalf, values });
    ...
    function populateAccountDropdown() {
        const dropdown = document.getElementById('incomeAccount');
        if (!dropdown) {
            console.error('Dropdown not found');
            return;
        }
        
        console.log('Populating dropdown with accounts:', allAccounts);
        ...
        allAccounts.forEach(account => {
            ...
            option.textContent = `${typeEmoji[account.type] || 'ðŸ’³'} ${account.name}`;
            dropdown.appendChild(option);
    ...
    function updateAccountsTable() {
        ...
        allAccounts.forEach((account, index) => {
            ...
            row.innerHTML = `
                <td style="padding: 15px; text-align: left; color: #333; border-right: 1px solid rgba(0,0,0,0.1); font-weight: 600;">${typeEmoji[account.type] || 'ðŸ’³'} ${account.name}</td>
                <td style="padding: 15px; text-align: left; color: #333; border-right: 1px solid rgba(0,0,0,0.1);">
                    <span style="display: inline-block; padding: 4px 10px; border-radius: 12px; background: linear-gradient(135deg, #B3D9FF 0%, #a5d4ff 100%); color: #0F172A; font-weight: 600; font-size: 11px;">${account.type.replace('_', ' ')}</span>
                </td>
                <td style="padding: 15px; text-align: right; color: #16A34A; border-right: 1px solid rgba(0,0,0,0.1); font-weight: 700;">${parseFloat(account.balance).toFixed(2)}</td>
                <td style="padding: 15px; text-align: left; color: #333; border-right: 1px solid rgba(0,0,0,0.1);">${account.createdAt}</td>
                <td style="padding: 15px; text-align: center; color: #333;">
                    <button type="button" class="btn btn-small btn-edit" onclick="editAccount(${account.id})" style="padding: 6px 10px; font-size: 11px; margin-right: 4px;">âœï¸</button>
                    <button type="button" class="btn btn-small btn-delete" onclick="deleteAccount(${account.id})" style="padding: 6px 10px; font-size: 11px;">ðŸ—‘ï¸</button>
                </td>
